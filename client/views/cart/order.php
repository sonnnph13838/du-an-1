                ...
                <div class="address_order">
                    ...
                    <div class="form_top">
                        <div class="form-label-group">
                            ...
                            <input type="text" name="name" id="inputFullname" class="form-control" placeholder="Họ và tên" value="">

                        </div>
                        <div class="form-label-group">
                            <label for="inputPhone"><span>Điện thoại <i class="text-danger">*</i></span></label>
                            <input type="text" name="phone" id="inputPhone" maxlength="10" class="form-control" placeholder="Điện thoại" value="">

                        </div>
                        <div class="form-label-group">
                            <label for="inputEmail"><span>Email <i class="text-danger">*</i></span></label>
                            <input type="email" name="email" id="inputEmail" class="form-control" placeholder="Email" value="">

                        </div>
                        <div class="form-label-group">
                            <label for="inputAddress"><span>Địa chỉ (Số nhà - Tên đường) <i class="text-danger">*</i></span></label>
                            <input type="text" name="address" id="inputAddress" class="form-control" placeholder="Địa chỉ (Số nhà - Tên đường)" value="">
